...
for (let i = 0; i < 10000 - 1; i++) {
    ...
    while (canMove && notInfiniteLoop < 1000) {
        ...
        if (index == 0) {
            ...
            console.log(i - iPattern, tab.length - lengthPattern);
            console.log('\n');
            iPattern = i;
            lengthPattern = tab.length;
        } 
        currentIndexTab++;
    }
...
console.log(2574 * 583090378 + 2612);


/*
calculs

1000000000000 - 1723 = 999999998277
999999998277 // 1715 = 583090378
999999998277 % 1715 = 7
2574 * 583090378 + 2612 = 
*/
